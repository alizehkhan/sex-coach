...
const Credentials = () => {
  return (
    <div className="mt-24">
      ...
      <ul className="grid gap-4 grid-cols-[repeat(auto-fit,minmax(400px,1fr))]">
        {CREDENTIALS.map((credential, i) => (
          <li
            key={i}
            className="flex sm:flex-row flex-col bg-white py-4 px-6 items-center rounded-lg shadow-sm gap-6"
          >
            <Image
