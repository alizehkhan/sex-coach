...
const About = () => {
  return (
    <>
      <div className="h-[calc(90vh-80px)] bg-[linear-gradient(180deg,rgba(0,0,0,0.00)45%,rgba(0,0,0,0.20)70%),url('/haneen/haneen-1.png')] bg-cover bg-center bg-no-repeat flex items-end">
