...
const Workshops = () => {
  return (
    <>
      <div className="flex h-screen items-end bg-[linear-gradient(180deg,rgba(0,0,0,0.00)45%,rgba(0,0,0,0.20)70%),url('/haneen/haneen-3.png')] bg-cover bg-center bg-no-repeat">
